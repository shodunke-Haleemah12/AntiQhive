...
const Training = () => {
  ...
  const impactStats = [
    {
      icon: <FaUsers className="text-[#f4c20d] text-4xl" />,
      number: "300+",
      label: "Students Trained",
    },
    {
      icon: <FaAward className="text-[#f4c20d] text-4xl" />,
      number: "11",
      label: "Industry Awards",
    },
    {
      icon: <FaProjectDiagram className="text-[#f4c20d] text-4xl" />,
      number: "120+",
    ...
    <div className="w-full bg-white text-black">
      ...
      <section className="bg-black text-white py-28 px-6 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold mb-4">
          Professional Tech Training at <span className="text-[#f4c20d]">Spin</span> Design
        </h1>
...
<section className="bg-gray-50 py-24 px-6">
  <h2 className="text-3xl font-semibold text-center mb-16">Our Real Impact</h2>
          ...
          <div className="flex items-center gap-8 min-w-max justify-center">
            {steps.map((step, index) => (
              <React.Fragment key={index}>
                <div className="px-10 py-6 rounded-full bg-white shadow-md font-medium hover:bg-[#f4c20d] hover:text-black transition">
                  {step}
                </div>
